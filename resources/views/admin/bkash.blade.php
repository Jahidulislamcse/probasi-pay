 ...
 <div class="app-header st1">
     <div class="tf-container">
         <div class="tf-topbar d-flex justify-content-center align-items-center">
             ...
             <h3 class="white_color">বিকাশ পে</h3>
         </div>
     </div>
 </div>
     ...
     <form class="tf-form" method="post">
         ...
         <div class="tf-container">
             <div class="tf-balance-box">
                 ...
                 <img src="/images/bkash.png" style="width: 200px;display: block;margin: 13px auto;">
             ...
             <div class="modal-dialog modal-dialog-centered">
                 <div class="modal-content bk-modal">
                     <div class="text-center mt-3">
                         <img src="/images/bkash.png" style="width: 100px; display: block; margin: 0 auto;">
                     </div>
