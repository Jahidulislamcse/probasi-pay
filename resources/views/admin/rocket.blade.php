 ...
 <div class="app-header st1">
     <div class="tf-container">
         <div class="tf-topbar d-flex justify-content-center align-items-center">
             ...
             <h3 class="white_color">রকেট পে</h3>
         </div>
     </div>
 </div>
     ...
     <form class="tf-form" method="post">
         ...
         <div class="tf-container">
             <div class="tf-balance-box">
                 ...
                 <img src="/images/rocket.png" style="width: 100px;display: block;margin: 13px auto;">
             ...
             <div class="modal-dialog modal-dialog-centered">
                 <div class="modal-content bk-modal">
                     <div class="text-center mt-3">
                         <img src="/images/rocket.png" style="width: 100px; display: block; margin: 0 auto;">
                     </div>

                     <div class="bk-body">
                         <div class="bk-summary">
                             <div class="bk-col">
                                 <div class="bk-col-title">একাউন্ট নম্বর</div>
                                 <div class="bk-col-value" id="mAccount">—</div>
                             </div>
                             <div class="bk-sep"></div>
                             <div class="bk-col">
                                 <div class="bk-col-title">এমাউন্ট</div>
                         ...
                         <div class="bk-summary">
                             <div class="bk-col">
                                 <div class="bk-col-title">ট্রানজেকশন টাইপ</div>
                         ...
                         <button type="submit" class="btn bk-btn mt-3">কনফার্ম</button>
                     </div>
                 </div>
             </div>
         </div>
