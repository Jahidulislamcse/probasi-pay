     ...
     <div class="app-header st1">
         <div class="tf-container">
             <div class="tf-topbar d-flex justify-content-center align-items-center">
                 ...
                 <h3 class="white_color">মোবাইল রিচার্জ</h3>
             </div>
         </div>
     </div>
         ...
         <form class="tf-form" method="post">
             ...
             <div class="tf-container">
                 <div class="tf-balance-box">
                     ...
                     <!--        <option value="">আপনার অপারেটর সিলেক্ট করুন</option>-->
                     <!--        <option value="GP">গ্রামীনফোন</option>-->
                     <!--        <option value="TELITALK">টেলিটক</option>-->
                     <!--        <option value="ROBI">রবি</option>-->
                     <!--        <option value="AIRTEL">এয়ারটেল</option>-->
                     <!--    </select>-->
