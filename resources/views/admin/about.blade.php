...
<div class="header">
    <div class="tf-container">
        <div class="tf-statusbar d-flex justify-content-center align-items-center">
            ...
            <h3 style="color:white;">আমাদের সম্পর্কে</h3>
        </div>
    </div>
</div>
...
<h3 style="color:red;font-size: 20px;">আমাদের সম্পর্কে:-<br></h3><br>
...
</p><h3 style="color:red;font-size: 20px;"><br>আমাদের সার্ভিসসমূহ হল :-</h3>
...
<h3 style="color:red;font-size: 20px;">এতো এতো প্রতারকের মধ্যে আপনাদেরকে কিভাবে বিশ্বাস করবো? <br></h3><br>
...
অ্যাপে রয়েছে হেল্প সেন্টার যেখানে আপনি ২৪ ঘন্টা যেকোন সমস্যার সমাধান পাবেন| <p><br>
<p style="color:red; font-size: 19px;  text-align: justify;">আপনারা রেট কিভাবে বেশি দিচ্ছেন? <br><br><p><p style="color:black; font-size:19px;  text-align: justify;">
