...
class SettingController extends Controller
{
    ...
    public function general(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            try {
                ...
                $data->company_name = $request->company_name ?: $data->code();
                ...
                if ($data->save()) {
                    return redirect(route('setting.general'))->with(['response' => true, 'msg' => 'Category Create/update Success']);
                } else {
                    return redirect(route('setting.general'))->with(['response' => false, 'msg' => 'Category Create/update Fail!']);
                }
            } catch (\Throwable $th) {
                return redirect(route('setting.general'))->with(['response' => false, 'msg' => $th->getMessage()]);
            }
        }
        ...
        return view('admin.setting.general', compact(['title', 'data']));
    }
    ...
    public function mobilebanking(Request $request, $id = null)
    {
        ...
        return view('admin.setting.mobilebanking', compact('title', 'data', 'list'));
    }
    ...
    public function bank(Request $request, $id = null)
    {
        ...
        return view('admin.setting.bank', compact('title', 'data', 'list'));
    }
    ...
    public function country(Request $request, $id = null)
    {
        ...
        $list = Country::all();
        return view('admin.setting.country', compact('title', 'data', 'list'));
    }
    ...
    public function slider(Request $request, $id = null)
    {
        ...
        $list = Slider::all();
        return view('admin.setting.slider', compact('title', 'data','list'));
    }
