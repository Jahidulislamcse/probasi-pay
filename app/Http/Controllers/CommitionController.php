...
class CommitionController extends Controller
{
    public function index()
    {
        ...
        return view('admin.commission.index', compact('title', 'commitions'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.commission.create', compact('title', 'commition'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.commission.edit', compact('title', 'commition'));
    }
