...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['controller' => AdminController::class], function () {
        Route::get('/admin/users/{user}', [AdminController::class, 'userInfo'])->name('admin.users.show');
        Route::get('/user/block/{id}', [AdminController::class, 'blockUser'])->name('user.block');
    ...
    Route::group(['controller' => RemittanceController::class], function () {
        ...
        Route::match(['get', 'post'], 'user/remittance', 'remittance')->name('remittance');
    });
